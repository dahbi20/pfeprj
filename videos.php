...
if (isset($_GET['ch'])) {
  ...
  ?>
          ...
          <ul>
            ...
            while ($chapter_row = $chapter_res->fetch_assoc()) {
              ...
              if ($chapter_row['cid'] == $chapter) {
                # code...
            ?>
                <a href="videos.php?ch=<?php echo $chapter_row['cid']; ?>">
                  <li style="background:#555;"><?php echo $chapter_row['name']; ?></li>
                </a>
              <?php
              } else {
              ?>
                <a href="videos.php?ch=<?php echo $chapter_row['cid']; ?>">
                  <li><?php echo $chapter_row['name']; ?></li>
                </a>
            <?php
              }
            }
            ...
            ?>
                ...
                <?php if ($book_row['doc'] != 0) : ?>
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Télécharger pièce jointe</h4>
                  </div>
                  <div class="modal-body">
                    ...
                    ?>
                      ...
                      <a href="<?php echo $book_row['link'] ?>" target="_blank"><button style="" class="btn btn-info btn-lg">Télécharger pièce jointe</button></a>
                    <?php
              ...
              <ul>
                ...
                while ($playlist_row = $playlist_res->fetch_assoc()) {
                  if ($playlist_row['vid'] == $curr) {
                    # code...
                ?>
                    <a href="videos.php?v=<?php echo $playlist_row['vid'] ?>">
                      <li style="background:#f5f5f5;color:#555;"><?php echo $playlist_row['name']; ?></li>
                    </a>
                  <?php
                  } else {
                  ?>
                    <a href="videos.php?v=<?php echo $playlist_row['vid'] ?>">
                      <li><?php echo $playlist_row['name']; ?></li>
                    </a>
                <?php
                  }
                }
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                if ($book_row['doc'] == 1) {
                  # code...
                ?>
                  <p>Nous avons joint un fichier PDF de questions importantes.</p>
                  <a href="<?php echo $book_row['link'] ?>" target="_blank"><button style="" class="btn btn-info btn-lg">Télécharger pièce jointe</button></a>
                <?php
                } elseif ($book_row['doc'] == 2) {
                  # code...
      ...
      ?>
        <script>
          alert("Aucune vidéo dans ce chapitre. Veuillez vérifier après un certain temps");
          window.location.assign("dashboard.php");
        </script>
      <?php
      }
        ...
        <ul>
          ...
          while ($book_row = $book_res->fetch_assoc()) {
            ...
            if ($book_row['cid'] == $chapter) {
              # code...
          ?>
              <a href="videos.php?ch=<?php echo $book_row['cid']; ?>">
                <li style="background:#555;"><?php echo $book_row['name']; ?></li>
              </a>
            <?php
            } else {
            ?>
              <a href="videos.php?ch=<?php echo $book_row['cid']; ?>">
                <li><?php echo $book_row['name']; ?></li>
              </a>
          <?php
            }
          }
        ...
        <ul>
          ...
          while ($video_row = $video_res->fetch_assoc()) {
            if ($video_row['vid'] == $vid) {
              # code...
          ?>
              <a href="videos.php?v=<?php echo $video_row['vid'] ?>">
                <li style="background:#f5f5f5;color:#555;"><?php echo $video_row['name']; ?></li>
              </a>
            <?php
            } else {
            ?>
              <a href="videos.php?v=<?php echo $video_row['vid'] ?>">
                <li><?php echo $video_row['name']; ?></li>
              </a>
          <?php
            }
          }
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            if ($doc_row['doc'] == 1) {
              # code...
            ?>
              <p>Nous avons joint un fichier PDF questions importantes pour vous d’expliquer plus.</p>
              <a href="<?php echo $doc_row['link'] ?>" target="_blank"><button style="" class="btn btn-info btn-lg">Télécharger pièce jointe</button></a>
            <?php
            } elseif ($doc_row['doc'] == 2) {
              # code...
            ?>
              <p>Nous avons joint un fichier PDF d’explication pour que vous expliquiez plus.</p>
              <a href="<?php echo $doc_row['link'] ?>" target="_blank"><button style="" class="btn btn-info btn-lg">Télécharger pièce jointe</button></a>
            <?php
            }
            ?>
