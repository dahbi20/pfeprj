...
<div class="video-menu" style="height: 70px;">
 <ul>
 <a href="teacher_dashboard.php"><li> Cours
  </li></a>
...
Cliquer ici pour télecharger PDF -->
	<input type="file" name="files[]" multiple/>
	<input type="submit"/><br>
Cliquer ici pour télecharger un Document -->
    <input type="file" name="files[]" multiple/>
    <input type="submit"/><br>  
Cliquer ici pour télecharger un fichier text -->
    <input type="file" name="files[]" multiple/>
    <input type="submit"/>
    </form>
    </div>
